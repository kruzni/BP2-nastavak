...
#GUI
frame1BolnicaSOvlastima = Frame(root)
frame2 = Frame(root)
frame1BolnicaSOvlastima['bg'] = '#9E5D5D'
frame1BolnicaSOvlastima.grid(row = 0, column = 0, sticky='nsew')
frame2.grid(row = 0, column = 1, sticky='nsew')

label = Label(frame1BolnicaSOvlastima, text = "Sustav upravljanja bolnicama", font=('Arial Bold',20))
label.grid(row=5,column=7,columnspan=50,rowspan=5,padx=50,pady=30)


bolnicaIDLabel = Label(frame1BolnicaSOvlastima,text = "id",font=('Arial',11))
bolnicaNazivLabel = Label(frame1BolnicaSOvlastima,text = "Naziv bolnice",font=('Arial',11)) 
bolnicaAdresaLabel = Label(frame1BolnicaSOvlastima,text = "Adresa bolnice",font=('Arial',11)) 
bolnicaGradLabel = Label(frame1BolnicaSOvlastima,text = "Grad bolnice",font=('Arial',11)) 
bolnicaKontaktLabel = Label(frame1BolnicaSOvlastima,text = "Kontakt bolnice",font=('Arial',11)) 
bolnicaEmailLabel = Label(frame1BolnicaSOvlastima,text = "Email bolnice",font=('Arial',11)) 
bolnicaZalihaKrvneGrupeAPoz = Label(frame1BolnicaSOvlastima,text= "A+",font=('Arial',11))
bolnicaZalihaKrvneGrupeANeg = Label(frame1BolnicaSOvlastima,text= "A-",font=('Arial',11))
bolnicaZalihaKrvneGrupeBPoz = Label(frame1BolnicaSOvlastima,text= "B+",font=('Arial',11))
bolnicaZalihaKrvneGrupeBNeg = Label(frame1BolnicaSOvlastima,text= "B-",font=('Arial',11))
bolnicaZalihaKrvneGrupeABPoz = Label(frame1BolnicaSOvlastima,text= "AB+",font=('Arial',11))
bolnicaZalihaKrvneGrupeABNeg = Label(frame1BolnicaSOvlastima,text= "AB-",font=('Arial',11))
bolnicaZalihaKrvneGrupe0Poz = Label(frame1BolnicaSOvlastima,text= "0+",font=('Arial',11))
bolnicaZalihaKrvneGrupe0Neg = Label(frame1BolnicaSOvlastima,text= "0-",font=('Arial',11)) 
...
bolnicaIDEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj1Bolnica)
nazivEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj2Bolnica)
adresaEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj3Bolnica)
gradEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj4Bolnica)
kontaktEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj5Bolnica)
emailEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj6Bolnica)
zaliha_Krvne_Grupe_A_PozEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj7Bolnica)
zaliha_Krvne_Grupe_A_NegEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj8Bolnica)
zaliha_Krvne_Grupe_B_PozEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj9Bolnica)
zaliha_Krvne_Grupe_B_NegEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj10Bolnica)
zaliha_Krvne_Grupe_AB_PozEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj11Bolnica)
zaliha_Krvne_Grupe_AB_NegEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj12Bolnica)
zaliha_Krvne_Grupe_0_PozEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj13Bolnica)
zaliha_Krvne_Grupe_0_NegEntry=Entry(frame1BolnicaSOvlastima,width=55,bd=3,font=('Arial',11), textvariable=rezmj14Bolnica)
...
addBtnBolnica=Button(frame1BolnicaSOvlastima, text="Dodaj",padx=25,pady=25,width=5,bd=5,font=('Arial',15),bg="white",fg="red", command=addBolnica)
updateBtnBolnica=Button(frame1BolnicaSOvlastima, text="Ažuriraj",padx=25,pady=25,width=5,bd=5,font=('Arial',15),bg="white",fg="red", command=updateBolnica)
searchBtnBolnica=Button(frame1BolnicaSOvlastima, text="Pretraži",padx=25,pady=25,width=5,bd=5,font=('Arial',15),bg="white",fg="red", command=searchBolnica)
selectBtnBolnica=Button(frame1BolnicaSOvlastima, text="Izaberi",padx=25,pady=25,width=5,bd=5,font=('Arial',15),bg="white",fg="red", command=selectBolnica)

addBtnBolnica.grid(row=3,column=5,columnspan=1,rowspan=2)
updateBtnBolnica.grid(row=3,column=7,columnspan=1,rowspan=2)
searchBtnBolnica.grid(row=3,column=9,columnspan=1,rowspan=2)
selectBtnBolnica.grid(row=3,column=11,columnspan=1,rowspan=2)

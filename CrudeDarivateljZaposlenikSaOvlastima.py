...
#GUI
frame1Darivatelj_Z_S_Ovlastima = Frame(root)
frame2 = Frame(root)
frame1Darivatelj_Z_S_Ovlastima['bg'] = '#9E5D5D'
frame1Darivatelj_Z_S_Ovlastima.grid(row = 0, column = 0, sticky='nsew')
frame2.grid(row = 0, column = 1, sticky='nsew')

labelDarivatelj = Label(frame1Darivatelj_Z_S_Ovlastima, text = "Sustav upravljanja darivateljima", font=('Arial Bold',20))
labelDarivatelj.grid(row=5 ,column=5,columnspan=30,rowspan=5,padx=20,pady=30)


darivateljIDLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "id",font=('Arial',10))
darivateljIDKriterijLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "id_kriterij",font=('Arial',10))
darivateljImeLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Ime",font=('Arial',10))
darivateljPrezimeLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Prezime",font=('Arial',10))
darivateljOIBLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "OIB",font=('Arial',10))
darivateljSpolLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Spol",font=('Arial',10))
darivateljDatumRodenjaLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Datum rođenja",font=('Arial',10))
darivateljAdresaLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Adresa",font=('Arial',10))
darivateljGradLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Grad",font=('Arial',10))
darivateljKontaktLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Kontakt",font=('Arial',10))
darivateljKrvnaGrupaLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Krva grupa",font=('Arial',10))
darivateljDobLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Dob",font=('Arial',10))
darivateljTjelesnaTezinaLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Težina",font=('Arial',10))
darivateljTjelesnaTemperaturaLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Temperatura",font=('Arial',10))
darivateljSistolickiKrvniTlakLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Sistolički tlak",font=('Arial',10))
darivateljDijastolickiKrvniTlakLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Dijastolički tlak",font=('Arial',10))
darivateljPulsLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Puls",font=('Arial',10))
darivateljHemoglobinLabel = Label(frame1Darivatelj_Z_S_Ovlastima,text = "Hemoglobin",font=('Arial',10))
...
DarivateljIDEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj1Darivatelj)
DarivateljIDKriterijEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj2Darivatelj)
DarivateljImeEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj3Darivatelj)
DarivateljPrezimeEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj4Darivatelj)
DarivateljOIBEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj5Darivatelj)
DarivateljSpolEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj6Darivatelj)
DarivateljDatumRodenjaEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj7Darivatelj)
DarivateljAdresaEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj8Darivatelj)
DarivateljGradEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj9Darivatelj)
DarivateljKontaktEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj10Darivatelj)
DarivateljKrvnaGrupaEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj11Darivatelj)
DarivateljDobEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj12Darivatelj)
DarivateljTjelesnaTezinaEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj13Darivatelj)
DarivateljTjelesnaTemperaturaEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj14Darivatelj)
DarivateljSistolickiKrvniTlakEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj15Darivatelj)
DarivateljDijastolickiKrvniTlakEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj16Darivatelj)
DarivateljPulsEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj17Darivatelj)
DarivateljHemoglobinEntry=Entry(frame1Darivatelj_Z_S_Ovlastima,width=55,bd=5,font=('Arial',15), textvariable=rezmj18Darivatelj)
...
addBtn=Button(frame1Darivatelj_Z_S_Ovlastima, text="Dodaj",padx=25,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=addDarivatelj)
updateBtn=Button(frame1Darivatelj_Z_S_Ovlastima, text="Ažuriraj",padx=25,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=updateDarivatelj)
searchBtn=Button(frame1Darivatelj_Z_S_Ovlastima, text="Pretraži",padx=25,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=searchDarivatelj)
selectBtn=Button(frame1Darivatelj_Z_S_Ovlastima, text="Izaberi",padx=25,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=selectDarivatelj)


addBtn.grid(row=3,column=5,columnspan=1,rowspan=2)
updateBtn.grid(row=3,column=7,columnspan=1,rowspan=2)
searchBtn.grid(row=3,column=9,columnspan=1,rowspan=2)
selectBtn.grid(row=3,column=11,columnspan=1,rowspan=2)

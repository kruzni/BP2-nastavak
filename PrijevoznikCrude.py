...
updateBtnPrijevoznik=Button(framePrijevoznikAdmin, text="Ažuriraj",padx=25,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=updatePrijevoznik)
deleteBtnPrijevoznik=Button(framePrijevoznikAdmin, text="Izbriši",padx=25,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=deletePrijevoznik)
searchBtnPrijevoznik=Button(framePrijevoznikAdmin, text="Pretraži",padx=25,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=searchPrijevoznik)
